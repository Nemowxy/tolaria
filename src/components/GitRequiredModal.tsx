  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-5 rounded-xl border border-border bg-background p-8 shadow-lg">
        ...
        <h2 className="m-0 text-lg font-semibold text-foreground">{t('gitRequired.heading')}</h2>
        ...
        <div className="flex w-full flex-col gap-2">
          <button
            ...
            disabled={creating}
          >
            {creating ? t('gitRequired.creating') : t('gitRequired.createRepository')}
          </button>
          <button
            ...
            disabled={creating}
          >
            {t('gitRequired.chooseAnotherVault')}
          </button>
        </div>
      </div>
    </OnboardingShell>
