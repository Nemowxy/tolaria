...
function renderAvailableContent(
  ...
  return (
    <>
      ...
      <span>
        <strong>{t('updateBanner.appVersion', { version: status.displayVersion })}</strong> {t('updateBanner.isAvailable')}
      </span>
      <Button
        type="button"
        variant="link"
      ...
      >
        {t('updateBanner.releaseNotes')} <ExternalLink size={11} />
      </Button>
      <Button
        type="button"
        size="xs"
...
function renderDownloadingContent(
  ...
  return (
    <>
      ...
      <span>{t('updateBanner.downloadingVersion', { version: status.displayVersion })}</span>
...
function renderReadyContent(
  ...
  return (
    <>
      ...
      <span>
        <strong>{t('updateBanner.appVersion', { version: status.displayVersion })}</strong> {t('updateBanner.readyRestartToApply')}
      </span>
      <Button
        type="button"
        size="xs"
